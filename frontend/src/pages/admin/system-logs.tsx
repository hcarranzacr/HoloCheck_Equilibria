...
import { getSystemLogs } from '@/lib/supabase-admin';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 mt-2">Registro de actividad y eventos del sistema</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {logs.length === 0 ? (
              <p className="text-sm text-slate-600">No hay logs registrados</p>
            ) : (
              logs.map((log) => (
