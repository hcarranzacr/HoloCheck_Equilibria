  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 mt-2">Resultados de análisis generados por inteligencia artificial</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Análisis Recientes</CardTitle>
          <CardDescription>Últimos análisis generados por IA</CardDescription>
        </CardHeader>
        <CardContent>
