...
export default function HRAIAnalyses() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 mt-2">Insights generados por inteligencia artificial</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Análisis Recientes</CardTitle>
          <CardDescription>Recomendaciones y análisis de bienestar</CardDescription>
        </CardHeader>
        <CardContent>
